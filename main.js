...
async function connectionUpdate(update) {
  ...
  if (connection == 'open') {
      ...
      await  conn.fakeReply("6285640575421@s.whatsapp.net", '*NdaaBotz Berhasil Tersambung*','0@s.whatsapp.net','NdaaBotz-MD 🍁')
      // await conn.reply("6285651409344@s.whatsapp.net", 'Hikari berhasil Tersambung', null)
  }
  if (connection == 'close') console.log(chalk.red('⏹️Server berhenti dan mencoba menghubungkan kembali...'))
